...
<CardGrid>
  <LinkCard
    title="New Mint"
    href="/new-mint/"
    description="Starting fresh. Stand up Bitcoin, Lightning, and your mint, then connect them to Orchard."
  />
  <LinkCard
    title="Already Have a Mint"
    href="/existing-mint/"
    description="Already running parts of the stack. Connect Orchard to your existing services."
  />
</CardGrid>
