...
Bitcoin Core, your Lightning node, the mint, and Orchard all run
...
VPS maximizes uptime and reachability. This guide covers the home server primarily,
but a VPS is a reasonable alternative.
